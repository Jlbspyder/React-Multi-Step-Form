  ...
  return (
    <div className="md:absolute bg-White mt-[115px] ml-10 h-[400px] rounded-lg pt-1 md:mt-32 w-[330px] md:w-[450px] md:-top-[60px] md:left-[500px]">
      ...
      <div className="flex flex-col w-[420px] mt-6">
        <div className="bg-Alabaster w-[73%] h-[190px] ml-3 md:ml-[50px] md:h-[200px] md:w-[410px] md:mt-1 rounded-lg md:rounded-lg border-slate-200 border-[1px]">
          {
          ...
          <div className="flex flex-col">
            {customerInfo.addOns.map((item,index) => {
              return (
                  <div key={index} className="flex flex-row justify-between mt-5 pl-5 pr-5">
